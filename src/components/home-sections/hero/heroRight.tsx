...
const HeroRight = () => {
  ...
  return (
    <div className="hero-right mt-8 sm:mt-3 sm:w-1/2 relative overflow-hidden" data-aos="zoom-in" data-aos-delay="1000">
      <div className="glowing absolute w-[150%] h-[80%] left-0"></div>
